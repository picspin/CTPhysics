...
const dict: Record<Language, Translations> = {
  "zh": {
    ...
    "pcct_tab_3d": "3D 视图",
    "pcct_3d_hint": "鼠标拖动旋转 / 滚轮缩放",
    "pcct_3d_caption": "EID 间接转换 (左) vs PCD 直接转换 (右)",
    "pcct_3d_eid_title": "EID — 间接转换",
    "pcct_3d_eid_l1": "闪烁体 (GOS/CsI): X射线 → 可见光",
    "pcct_3d_eid_l2": "光在层内横向散射 → 像素尺寸下限",
    "pcct_3d_eid_l3": "钨反射隔片 (septa) 形成死区",
    "pcct_3d_eid_l4": "能量积分: 无能谱分辨 + 电子噪声累加",
    "pcct_3d_pcd_title": "PCD — 直接转换",
    "pcct_3d_pcd_l1": "CdTe / CZT 半导体: X射线 → 电子-空穴对",
    "pcct_3d_pcd_l2": "高压偏置电场沿场线漂移到阳极像素",
    "pcct_3d_pcd_l3": "无 septa: 微像素, 几何剂量效率高",
    "pcct_3d_pcd_l4": "脉冲高度 ∝ 光子能量, 按阈值分桶计数",
    "pcct_3d_nonideal_title": "非理想效应",
    "pcct_3d_share_desc": "电荷云跨越像素边界时, 单一光子的能量被相邻像素分摊 — 两端均记录为低能事件 (谱线畸变)。",
    "pcct_3d_pileup_desc": "高通量下脉冲在时间轴上重叠 — 被误读为单一高能事件或丢失 (高通量计数饱和)。",
    "cbct_sim_geometry_label": "几何模式 (Geometry Mode)",
    "cbct_sim_geometry_cone": "锥形束 (Cone Beam - CBCT)",
    "cbct_sim_geometry_fan": "扇形束 (Fan Beam - 对比传统CT)",
    "cbct_sim_geometry_hint": "切换以对比 CBCT 与传统扇形束 CT 的几何差异。",
    "cbct_sim_3d_title": "3D 锥形束CT 设备与光路",
    "cbct_sim_3d_hint": "鼠标拖拽旋转视角 · 滚轮缩放 · 拖动滑块观察锥角增大时 FPD 上偏轴伪影与散射雾化的变化",
    "cbct_sim_3d_status_standby": "待机 (STANDBY)",
    "cbct_sim_3d_status_exposure": "曝光中 (EXPOSURE)",
    "cbct_sim_3d_footer": "SID: 1000mm · 锥角 ∝",
    "cbct_sim_3d_fpd": "FPD",
    "cbct_sim_3d_px": "px"
  },
  "en": {
    ...
    "pcct_tab_3d": "3D View",
    "pcct_3d_hint": "Mouse drag to rotate / scroll to zoom",
    "pcct_3d_caption": "EID Indirect (left) vs PCD Direct (right)",
    "pcct_3d_eid_title": "EID — Indirect Conversion",
    "pcct_3d_eid_l1": "Scintillator (GOS/CsI): X-ray → visible light",
    "pcct_3d_eid_l2": "Lateral light scatter sets the pixel-size floor",
    "pcct_3d_eid_l3": "Tungsten septa create geometric dead space",
    "pcct_3d_eid_l4": "Energy integration: no spectral info + electronic noise adds",
    "pcct_3d_pcd_title": "PCD — Direct Conversion",
    "pcct_3d_pcd_l1": "CdTe / CZT semiconductor: X-ray → e⁻/h⁺ pairs",
    "pcct_3d_pcd_l2": "HV bias field drifts charges to anode pixels",
    "pcct_3d_pcd_l3": "No septa: micro-pixels, high geometric dose efficiency",
    "pcct_3d_pcd_l4": "Pulse height ∝ photon energy, counted into bins",
    "pcct_3d_nonideal_title": "Non-ideal Effects",
    "pcct_3d_share_desc": "When the charge cloud straddles a pixel boundary, one photon's energy is split across neighbours — both register low-energy counts.",
    "pcct_3d_pileup_desc": "At high flux, pulses overlap in time and are misread as a single higher-energy event (or lost).",
    "cbct_sim_geometry_label": "Geometry Mode",
    "cbct_sim_geometry_cone": "Cone Beam (CBCT)",
    "cbct_sim_geometry_fan": "Fan Beam (compare conventional CT)",
    "cbct_sim_geometry_hint": "Toggle to compare CBCT vs. conventional fan-beam CT geometry.",
    "cbct_sim_3d_title": "3D CBCT Scanner & Beam Path",
    "cbct_sim_3d_hint": "Drag to orbit · Scroll to zoom · Move sliders to see off-axis FPD artifacts and scatter grow with cone angle",
    "cbct_sim_3d_status_standby": "STANDBY",
    "cbct_sim_3d_status_exposure": "EXPOSURE",
    "cbct_sim_3d_footer": "SID: 1000mm · Cone ∝",
    "cbct_sim_3d_fpd": "FPD",
    "cbct_sim_3d_px": "px"
  }
};
